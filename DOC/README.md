...
- [../AGENTS.md](../AGENTS.md)
  - 작업자/에이전트용 저장소 운영 지침
- [releases/RELEASE_NOTES_v1.11.6.md](./releases/RELEASE_NOTES_v1.11.6.md)
  - 최신 로컬 한글 릴리스 노트 (v1.11.6)
- [releases/RELEASE_NOTES_v1.11.6_EN.md](./releases/RELEASE_NOTES_v1.11.6_EN.md)
  - 최신 로컬 영문 릴리스 노트 (v1.11.6)
