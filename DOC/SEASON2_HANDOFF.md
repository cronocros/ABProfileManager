...
| 항목 | 상태 | 확정 방법 |
| --- | --- | --- |
| 시즌 2 M+ 아이템 레벨 (신화 0 ~ +12) | 확정 | 2026-08-28 인게임 표 실측 |
| 등급별 최대 아이템 레벨 (`gradeMax`) | 유도값만 있음 | 아이템 강화 NPC 트랙 표에서 각 등급 `6/6` 확인 |
| 제작 base / r5 아이템 레벨 | 사실상 확정 (`318` / `331`) | 두 출처 일치. 인게임 툴팁으로 최종 확인 |
