# ABProfileManager v1.7.7 -> v1.10.0 Major Update Announcement

Release baseline: `2026-05-31`

Since the `v1.7.7` baseline, ABProfileManager has received a major BIS recommendation update. This announcement summarizes the cumulative changes delivered in `v1.8.0`, `v1.9.0`, and `v1.10.0`.
