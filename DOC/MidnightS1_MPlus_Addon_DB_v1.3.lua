...
-- BEGIN v1.2 단일 2차 스탯 우선순위 오버라이드
-- 사용자 요청: 컨텍스트/영웅특성별 분리 대신 각 전문화마다 대표 우선순위 1개만 사용한다.
DB.schemaVersion = "1.2"
DB.statPriorityMode = "SINGLE_USER_SELECTED_OR_VERIFIED_V1_2"
DB.generatedAtKST = "2026-05-31"
DB.SINGLE_STAT_PRIORITY_V12 = {
  DEATHKNIGHT_BLOOD = { secondaryPriority="치명타 및 극대화 > 가속 > 유연성 = 특화", secondaryOrder={"치명타 및 극대화","가속","유연성","특화"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["가속"]=85, ["유연성"]=75, ["특화"]=75 }, statPriorityMode="SINGLE", statPriorityStatus="USER_SELECTED_4C", note="혈기 죽음의 기사 단일 대표값. Deathbringer/San’layn 분리 대신 사용자 선택 절충안." },
  DEATHKNIGHT_FROST = { secondaryPriority="치명타 및 극대화 >= 특화 >> 가속 > 유연성", secondaryOrder={"치명타 및 극대화","특화","가속","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["특화"]=95, ["가속"]=65, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  DEATHKNIGHT_UNHOLY = { secondaryPriority="치명타 및 극대화 >= 특화 >> 가속 >= 유연성", secondaryOrder={"치명타 및 극대화","특화","가속","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["특화"]=95, ["가속"]=65, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  DEMONHUNTER_DEVOURER = { secondaryPriority="특화 > 가속 > 치명타 및 극대화 >>> 유연성", secondaryOrder={"특화","가속","치명타 및 극대화","유연성"}, secondaryWeights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=70, ["유연성"]=30 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="포식은 지능 전문화." },
  DEMONHUNTER_HAVOC = { secondaryPriority="치명타 및 극대화 > 특화 >> 가속 > 유연성", secondaryOrder={"치명타 및 극대화","특화","가속","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["가속"]=55, ["유연성"]=45 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  DEMONHUNTER_VENGEANCE = { secondaryPriority="가속 >= 유연성 >= 치명타 및 극대화 > 특화", secondaryOrder={"가속","유연성","치명타 및 극대화","특화"}, secondaryWeights={ ["가속"]=100, ["유연성"]=95, ["치명타 및 극대화"]=90, ["특화"]=70 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED_ITEM_LEVEL_DOMINANT", note="탱커. 실제 평가는 아이템레벨/방어도/체력 보정 우선." },
  DRUID_BALANCE = { secondaryPriority="특화 > 치명타 및 극대화 = 가속 >> 유연성", secondaryOrder={"특화","치명타 및 극대화","가속","유연성"}, secondaryWeights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=85, ["유연성"]=45 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED_CORRECTED", note="" },
  DRUID_FERAL = { secondaryPriority="특화 > 가속 > 치명타 및 극대화 > 유연성", secondaryOrder={"특화","가속","치명타 및 극대화","유연성"}, secondaryWeights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=75, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  DRUID_GUARDIAN = { secondaryPriority="가속 > 특화 = 유연성 > 치명타 및 극대화", secondaryOrder={"가속","특화","유연성","치명타 및 극대화"}, secondaryWeights={ ["가속"]=100, ["특화"]=85, ["유연성"]=85, ["치명타 및 극대화"]=70 }, statPriorityMode="SINGLE", statPriorityStatus="USER_SELECTED_8C", note="Wowhead 방어 기준은 가속 > 유연성 > 특화 = 치명타. 사용자 선택 절충안 적용." },
  DRUID_RESTO = { secondaryPriority="특화 = 가속 >= 유연성 >> 치명타 및 극대화", secondaryOrder={"특화","가속","유연성","치명타 및 극대화"}, secondaryWeights={ ["특화"]=100, ["가속"]=100, ["유연성"]=90, ["치명타 및 극대화"]=45 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  EVOKER_DEVASTATION = { secondaryPriority="치명타 및 극대화 > 가속 = 특화 > 유연성", secondaryOrder={"치명타 및 극대화","가속","특화","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["가속"]=85, ["특화"]=85, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  EVOKER_PRESERVATION = { secondaryPriority="특화 > 치명타 및 극대화 = 가속 > 유연성", secondaryOrder={"특화","치명타 및 극대화","가속","유연성"}, secondaryWeights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=85, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="USER_SELECTED_3C", note="" },
  EVOKER_AUGMENTATION = { secondaryPriority="치명타 및 극대화 > 가속 > 특화 > 유연성", secondaryOrder={"치명타 및 극대화","가속","특화","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["가속"]=85, ["특화"]=70, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  HUNTER_BM = { secondaryPriority="치명타 및 극대화 > 가속 > 특화 > 유연성", secondaryOrder={"치명타 및 극대화","가속","특화","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["가속"]=85, ["특화"]=75, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="SOURCE_CONFLICT_REVIEW_RECOMMENDED", note="Wowhead 개요/M+ 성향은 치명타·가속 중심, Wowhead BiS 장비 페이지는 특화·가속 중심. 단일값은 M+ 개요/Archon 관측 쪽으로 설정." },
  HUNTER_MARKSMAN = { secondaryPriority="치명타 및 극대화 > 특화 > 가속 > 유연성", secondaryOrder={"치명타 및 극대화","특화","가속","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["가속"]=70, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  HUNTER_SURVIVAL = { secondaryPriority="특화 > 치명타 및 극대화 = 가속 > 유연성", secondaryOrder={"특화","치명타 및 극대화","가속","유연성"}, secondaryWeights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=85, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  MAGE_ARCANE = { secondaryPriority="특화 > 가속 >= 치명타 및 극대화 >> 유연성", secondaryOrder={"특화","가속","치명타 및 극대화","유연성"}, secondaryWeights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=80, ["유연성"]=45 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  MAGE_FIRE = { secondaryPriority="가속 >= 특화 > 유연성 >> 치명타 및 극대화", secondaryOrder={"가속","특화","유연성","치명타 및 극대화"}, secondaryWeights={ ["가속"]=100, ["특화"]=95, ["유연성"]=75, ["치명타 및 극대화"]=35 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  MAGE_FROST = { secondaryPriority="특화 >= 치명타 및 극대화 >> 유연성 >= 가속", secondaryOrder={"특화","치명타 및 극대화","유연성","가속"}, secondaryWeights={ ["특화"]=100, ["치명타 및 극대화"]=95, ["유연성"]=65, ["가속"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED_WITH_SOURCE_CONFLICT_NOTE", note="Wowhead 개요는 유연성 >= 가속, BiS 페이지는 가속 >= 유연성으로 표현 차이가 있음. 사용자 인식인 특 > 치 > 유 흐름을 우선 반영." },
  MONK_BREWMASTER = { secondaryPriority="치명타 및 극대화 > 유연성 = 특화 > 가속", secondaryOrder={"치명타 및 극대화","유연성","특화","가속"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["유연성"]=85, ["특화"]=85, ["가속"]=65 }, statPriorityMode="SINGLE", statPriorityStatus="USER_SELECTED_7C", note="Wowhead 방어 기준은 치명타 = 유연성 = 특화 > 가속. 사용자 선택 절충안 적용." },
  MONK_MISTWEAVER = { secondaryPriority="가속 > 치명타 및 극대화 = 유연성 > 특화", secondaryOrder={"가속","치명타 및 극대화","유연성","특화"}, secondaryWeights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["유연성"]=85, ["특화"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="USER_SELECTED_2C", note="" },
  MONK_WINDWALKER = { secondaryPriority="가속 = 치명타 및 극대화 = 특화 >>> 유연성", secondaryOrder={"가속","치명타 및 극대화","특화","유연성"}, secondaryWeights={ ["가속"]=100, ["치명타 및 극대화"]=100, ["특화"]=100, ["유연성"]=35 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  PALADIN_HOLY = { secondaryPriority="특화 > 가속 = 치명타 및 극대화 > 유연성", secondaryOrder={"특화","가속","치명타 및 극대화","유연성"}, secondaryWeights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=85, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  PALADIN_PROTECTION = { secondaryPriority="가속 > 유연성 = 치명타 및 극대화 > 특화", secondaryOrder={"가속","유연성","치명타 및 극대화","특화"}, secondaryWeights={ ["가속"]=100, ["유연성"]=85, ["치명타 및 극대화"]=85, ["특화"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  PALADIN_RETRIBUTION = { secondaryPriority="특화 > 치명타 및 극대화 > 가속 > 유연성", secondaryOrder={"특화","치명타 및 극대화","가속","유연성"}, secondaryWeights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=70, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  PRIEST_DISC = { secondaryPriority="가속 > 치명타 및 극대화 > 특화 > 유연성", secondaryOrder={"가속","치명타 및 극대화","특화","유연성"}, secondaryWeights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["특화"]=70, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED_GENERAL", note="쐐기 전용이면 유연성이 특화보다 앞설 수 있음. 단일 대표값은 일반/레이드 준비 기준." },
  PRIEST_HOLY = { secondaryPriority="치명타 및 극대화 > 유연성 = 특화 > 가속", secondaryOrder={"치명타 및 극대화","유연성","특화","가속"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["유연성"]=85, ["특화"]=85, ["가속"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="USER_SELECTED_1A", note="사용자 선택: 레이드/일반 힐량 기준." },
  PRIEST_SHADOW = { secondaryPriority="가속 > 특화 > 치명타 및 극대화 > 유연성", secondaryOrder={"가속","특화","치명타 및 극대화","유연성"}, secondaryWeights={ ["가속"]=100, ["특화"]=85, ["치명타 및 극대화"]=70, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_ICY_VERIFIED", note="" },
  ROGUE_ASSASSINATION = { secondaryPriority="치명타 및 극대화 >= 가속 >= 특화 >> 유연성", secondaryOrder={"치명타 및 극대화","가속","특화","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["가속"]=95, ["특화"]=90, ["유연성"]=45 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  ROGUE_OUTLAW = { secondaryPriority="가속 > 치명타 및 극대화 = 유연성 > 특화", secondaryOrder={"가속","치명타 및 극대화","유연성","특화"}, secondaryWeights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["유연성"]=85, ["특화"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="USER_SELECTED_6C", note="무법은 실제로 가속 목표치형. 사용자 선택에 따라 단일 절충안 적용." },
  ROGUE_SUBTLETY = { secondaryPriority="특화 > 가속 >= 치명타 및 극대화 >> 유연성", secondaryOrder={"특화","가속","치명타 및 극대화","유연성"}, secondaryWeights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=80, ["유연성"]=45 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  SHAMAN_ELEMENTAL = { secondaryPriority="특화 > 가속 = 치명타 및 극대화 >> 유연성", secondaryOrder={"특화","가속","치명타 및 극대화","유연성"}, secondaryWeights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=85, ["유연성"]=45 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  SHAMAN_ENHANCEMENT = { secondaryPriority="특화 = 가속 > 치명타 및 극대화 > 유연성", secondaryOrder={"특화","가속","치명타 및 극대화","유연성"}, secondaryWeights={ ["특화"]=100, ["가속"]=100, ["치명타 및 극대화"]=80, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="USER_SELECTED_5C", note="영웅 특성별 특화/가속 선호 차이를 단일 절충안으로 처리." },
  SHAMAN_RESTORATION = { secondaryPriority="치명타 및 극대화 > 특화 = 유연성 > 가속", secondaryOrder={"치명타 및 극대화","특화","유연성","가속"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["유연성"]=85, ["가속"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED_CORRECTED", note="" },
  WARLOCK_AFFLICTION = { secondaryPriority="특화 = 치명타 및 극대화 > 가속 > 유연성", secondaryOrder={"특화","치명타 및 극대화","가속","유연성"}, secondaryWeights={ ["특화"]=100, ["치명타 및 극대화"]=100, ["가속"]=80, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  WARLOCK_DEMONOLOGY = { secondaryPriority="가속 = 치명타 및 극대화 > 특화 > 유연성", secondaryOrder={"가속","치명타 및 극대화","특화","유연성"}, secondaryWeights={ ["가속"]=100, ["치명타 및 극대화"]=100, ["특화"]=80, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  WARLOCK_DESTRUCTION = { secondaryPriority="가속 = 치명타 및 극대화 > 특화 > 유연성", secondaryOrder={"가속","치명타 및 극대화","특화","유연성"}, secondaryWeights={ ["가속"]=100, ["치명타 및 극대화"]=100, ["특화"]=80, ["유연성"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  WARRIOR_ARMS = { secondaryPriority="치명타 및 극대화 > 가속 > 특화 > 유연성", secondaryOrder={"치명타 및 극대화","가속","특화","유연성"}, secondaryWeights={ ["치명타 및 극대화"]=100, ["가속"]=85, ["특화"]=70, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
  WARRIOR_FURY = { secondaryPriority="가속 > 특화 > 치명타 및 극대화 > 유연성", secondaryOrder={"가속","특화","치명타 및 극대화","유연성"}, secondaryWeights={ ["가속"]=100, ["특화"]=85, ["치명타 및 극대화"]=70, ["유연성"]=55 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED_CORRECTED", note="" },
  WARRIOR_PROTECTION = { secondaryPriority="가속 > 유연성 = 치명타 및 극대화 > 특화", secondaryOrder={"가속","유연성","치명타 및 극대화","특화"}, secondaryWeights={ ["가속"]=100, ["유연성"]=85, ["치명타 및 극대화"]=85, ["특화"]=60 }, statPriorityMode="SINGLE", statPriorityStatus="WOWHEAD_VERIFIED", note="" },
}

function DB.ApplySingleStatPriorityV12()
  if not SPECS then return false end
  for specKey, override in pairs(DB.SINGLE_STAT_PRIORITY_V12) do
    if SPECS[specKey] then
      SPECS[specKey].secondaryPriority = override.secondaryPriority
      SPECS[specKey].secondaryOrder = override.secondaryOrder
      SPECS[specKey].secondaryWeights = override.secondaryWeights
      SPECS[specKey].statPriorityVerified = true
      SPECS[specKey].statPriorityMode = override.statPriorityMode
      SPECS[specKey].statPriorityStatus = override.statPriorityStatus
      SPECS[specKey].statPriorityNote = override.note
      SPECS[specKey].contextSplitRequired = false
    end
  end
  return true
end

function DB.ScoreItemForSpecSingleV12(runtimeItemRecord, specKey)
  local spec = SPECS and SPECS[specKey]
  if not spec or not spec.secondaryWeights or not runtimeItemRecord then return 0 end
  local score = 0
  local stats = runtimeItemRecord.stats or {}
  for statName, weight in pairs(spec.secondaryWeights) do
    local value = stats[statName] or stats[string.upper(statName)] or 0
    score = score + (value * weight)
  end
  if runtimeItemRecord.actualItemLevel then
    score = score + runtimeItemRecord.actualItemLevel * 25
  end
  if runtimeItemRecord.tierSetPiece then score = score + 5000 end
  return score
end

DB.ApplySingleStatPriorityV12()
-- END v1.2 단일 2차 스탯 우선순위 오버라이드


-- BEGIN v1.3 최종 슬롯/아이템 우선순위 런타임 평가 패치
--[[
MidnightS1 M+ Addon DB v1.3
목적:
1) v1.2에서 사용자가 확정한 단일 대표 2차 스탯 우선순위를 유지한다.
2) 각 전문화/슬롯의 후보 아이템 우선순위를 정적 추측이 아니라 실제 신화 itemLink 기반으로 재계산한다.
3) 티어 4셋, 쐐기 신화 트랙, 실제 아이템 레벨, 실제 2차 스탯을 함께 사용한다.
4) itemId만으로 신화/영웅/일반 트랙을 판정하지 않는다.

주의:
- 이 파일의 정적 후보 풀은 공식 한글명/ID 검증용이다.
- 실제 우선순위 확정은 itemLink를 전달받아 C_Item.GetDetailedItemLevelInfo 및 C_Item.GetItemStats로 읽은 값으로 계산한다.
- 장신구와 무기 특수효과는 SimC/Raidbots/QE/로그 기반 보정이 필요하므로 A/B/C 등급은 UI 안내용 seed이며 최종 BiS 확정값이 아니다.
]]--

DB.schemaVersion = "1.3"
DB.generatedAtKST = "2026-05-31"

DB.V13_CHANGELOG = {
  "v1.2 단일 대표 2차 스탯 우선순위 유지",
  "전문화별 후보 아이템 우선순위 평가 함수를 추가",
  "티어 4셋은 고정 4부위 확정이 아니라 실제 itemLink/템렙/스탯으로 5부위 중 최적 4부위를 고르는 방식으로 변경",
  "신화 여부는 itemId가 아니라 itemLink/bonusIds/actualItemLevel/upgradeTrackText로만 검증",
  "장신구/무기 수동 seed 등급과 REVIEW_REQUIRED 표시 추가",
  "애드온 구현/검증/프롬프트를 DB 내부에 추가",
}

DB.SLOT_ORDER_V13 = {
  "HEAD", "NECK", "SHOULDERS", "BACK", "CHEST", "WRIST", "HANDS", "WAIST", "LEGS", "FEET", "FINGER", "TRINKET", "MAIN_HAND", "OFF_HAND"
}

DB.TIER_SLOTS_V13 = {
  HEAD=true, SHOULDERS=true, CHEST=true, HANDS=true, LEGS=true,
}

DB.NON_TIER_ARMOR_SLOTS_V13 = {
  WRIST=true, WAIST=true, FEET=true,
}

DB.ACCESSORY_SLOT_ALIASES_V13 = {
  NECK = "NECK",
  FINGER = "RING",
  FINGER1 = "RING",
  FINGER2 = "RING",
...
DB.PRIMARY_TOKEN_V13 = {
  ["힘"] = "STRENGTH",
  ["민첩"] = "AGILITY",
  ["지능"] = "INTELLECT",
}

DB.PRIMARY_STAT_KEYS_V13 = {
  ["힘"] = { "힘", "ITEM_MOD_STRENGTH_SHORT", "ITEM_MOD_STRENGTH" },
  ["민첩"] = { "민첩", "ITEM_MOD_AGILITY_SHORT", "ITEM_MOD_AGILITY" },
  ["지능"] = { "지능", "ITEM_MOD_INTELLECT_SHORT", "ITEM_MOD_INTELLECT" },
}

DB.V13_BIS_VALIDATION_LEVELS = {
  RUNTIME_VERIFIED = "RUNTIME_VERIFIED_BY_ITEMLINK_STATS_AND_MYTH_TRACK",
  RUNTIME_CANDIDATE = "RUNTIME_CANDIDATE_ITEMLINK_STATS_AVAILABLE_BUT_MYTH_TRACK_UNCONFIRMED",
  STATIC_POOL_ONLY = "STATIC_POOL_ONLY_ITEMLINK_REQUIRED_FOR_REAL_PRIORITY",
  REVIEW_REQUIRED = "REVIEW_REQUIRED_SIMC_QE_OR_LOGS_FOR_FINAL_BIS",
}

DB.TRINKET_PRIORITY_SEED_V13 = {
  -- 등급은 시작점일 뿐이며 장신구 특수효과는 SimC/Raidbots/QE/로그 보정이 필요하다.
  STRENGTH_DPS = {
    { id=193701, grade="A", reason="힘/민첩 딜러 공용 강력 후보. 최종은 심크 필요." },
    { id=252420, grade="A", reason="딜러 장신구 후보. 최종은 심크 필요." },
    { id=250241, grade="B", reason="힘 전용 후보. 최종은 심크 필요." },
    { id=193719, grade="B", reason="힘 전용 후보. 최종은 심크 필요." },
  },
  AGILITY_DPS = {
    { id=193701, grade="A", reason="민첩 딜러 공용 강력 후보. 최종은 심크 필요." },
    { id=252420, grade="A", reason="딜러 장신구 후보. 최종은 심크 필요." },
    { id=250226, grade="B", reason="민첩/힘 후보. 최종은 심크 필요." },
    { id=250227, grade="B", reason="민첩/힘 후보. 최종은 심크 필요." },
  },
  INTELLECT_DPS = {
    { id=250223, grade="A", reason="지능 딜러 후보. 최종은 심크 필요." },
    { id=193718, grade="A", reason="지능 딜러 후보. 최종은 심크 필요." },
    { id=151310, grade="B", reason="지능 딜러 후보. 최종은 심크 필요." },
    { id=50259, grade="B", reason="지능 딜러 후보. 최종은 심크 필요." },
  },
  HEALER_INTELLECT = {
    { id=252411, grade="A", reason="힐러 장신구 후보. 던전/레이드 패턴별 QE/로그 확인 권장." },
    { id=250253, grade="A", reason="힐러 장신구 후보. 던전/레이드 패턴별 QE/로그 확인 권장." },
    { id=250246, grade="B", reason="힐러 후보. QE 확인 권장." },
    { id=151340, grade="B", reason="힐러 후보. QE 확인 권장." },
  },
  TANK = {
    { id=252418, grade="A", reason="탱커 생존/딜 후보. 실제 던전/위험 패턴별 확인 필요." },
    { id=151312, grade="A", reason="탱커 생존 후보. 실제 던전/위험 패턴별 확인 필요." },
    { id=252421, grade="B", reason="탱커 후보. 실제 던전/위험 패턴별 확인 필요." },
  },
}

DB.TRINKET_GRADE_SCORE_V13 = { A=3000, B=1800, C=800 }

local function MS1V13_ContainsToken(value, token)
  if not value or not token then return false end
  return tostring(value):find(token, 1, true) ~= nil
end

local function MS1V13_CopyList(list)
  local out = {}
  for i, v in ipairs(list or {}) do out[#out+1] = v end
  return out
end

function DB.GetArmorPoolForSpecV13(specKey)
  local spec = SPECS and SPECS[specKey]
  if not spec then return {} end
  if spec.armor == "CLOTH" then return CLOTH_ARMOR or {} end
  if spec.armor == "LEATHER" then return LEATHER_ARMOR or {} end
  if spec.armor == "MAIL" then return MAIL_ARMOR or {} end
  if spec.armor == "PLATE" then return PLATE_ARMOR or {} end
  return {}
end

function DB.GetTierPiecesForSpecV13(specKey)
  local spec = SPECS and SPECS[specKey]
  if not spec or not spec.tierSetId or not TIER_SETS then return {} end
  local set = TIER_SETS[spec.tierSetId]
  if not set or not set.pieces then return {} end
  local out = {}
  for slot, piece in pairs(set.pieces) do
    out[#out+1] = {
      slot=slot, id=piece.id, ko=piece.ko, slotKo=piece.slotKo,
      source="GREAT_VAULT_DUNGEON_OR_CATALYST_FROM_MPLUS_ELIGIBLE_ITEM",
      tierSetId=spec.tierSetId, tierSetKo=spec.tierSetKo,
      tierSetPiece=true, priorityStatus="TIER_4SET_REQUIRED__CHOOSE_BEST_4_OF_5_BY_RUNTIME_SCORE"
    }
  end
  table.sort(out, function(a,b) return tostring(a.slot) < tostring(b.slot) end)
  return out
end

function DB.IsTierPieceForSpecV13(specKey, baseItemId)
  if not baseItemId then return false end
  for _, piece in ipairs(DB.GetTierPiecesForSpecV13(specKey)) do
    if tonumber(piece.id) == tonumber(baseItemId) then return true, piece end
  end
  return false, nil
end

function DB.GetAccessoryPoolForSlotV13(slot)
  local wanted = DB.ACCESSORY_SLOT_ALIASES_V13[slot] or slot
  local out = {}
  for _, item in ipairs(ACCESSORIES or {}) do
    if item.slot == wanted then out[#out+1] = item end
  end
  return out
end

function DB.GetStaticTrinketSeedForSpecV13(specKey)
  local spec = SPECS and SPECS[specKey]
  if not spec then return nil end
  if spec.role == "TANK" then return "TANK" end
  if spec.role == "HEALER" then return "HEALER_INTELLECT" end
  if spec.primary == "힘" then return "STRENGTH_DPS" end
  if spec.primary == "민첩" then return "AGILITY_DPS" end
  if spec.primary == "지능" then return "INTELLECT_DPS" end
  return nil
end

function DB.GetTrinketPoolForSpecV13(specKey)
  local spec = SPECS and SPECS[specKey]
  if not spec then return {} end
  local token = DB.GetStaticTrinketSeedForSpecV13(specKey)
  local seedById = {}
  for _, seed in ipairs((DB.TRINKET_PRIORITY_SEED_V13[token] or {})) do seedById[tonumber(seed.id)] = seed end
  local out = {}
  for _, item in ipairs(TRINKETS or {}) do
    local usable = item.usableBy or ""
    local ok = false
    if spec.role == "TANK" and MS1V13_ContainsToken(usable, "TANK") then ok = true end
    if spec.role == "HEALER" and MS1V13_ContainsToken(usable, "HEALER") then ok = true end
    if spec.primary == "힘" and MS1V13_ContainsToken(usable, "STRENGTH") then ok = true end
    if spec.primary == "민첩" and MS1V13_ContainsToken(usable, "AGILITY") then ok = true end
    if spec.primary == "지능" and MS1V13_ContainsToken(usable, "INTELLECT") then ok = true end
    if usable == "ALL_PRIMARY" then ok = true end
    if ok then
      local copy = {}
      for k,v in pairs(item) do copy[k]=v end
      copy.slot = "TRINKET"
      copy.trinketReviewRequired = true
      copy.finalBisVerified = false
      local seed = seedById[tonumber(item.id)]
      if seed then
        copy.manualGradeV13 = seed.grade
        copy.manualGradeReasonV13 = seed.reason
      else
        copy.manualGradeV13 = "C"
        copy.manualGradeReasonV13 = "사용 가능 후보이나 전문화별 SimC/QE/로그 보정 필요."
      end
      out[#out+1] = copy
    end
  end
  table.sort(out, function(a,b)
    local sa = DB.TRINKET_GRADE_SCORE_V13[a.manualGradeV13 or "C"] or 0
    local sb = DB.TRINKET_GRADE_SCORE_V13[b.manualGradeV13 or "C"] or 0
    if sa ~= sb then return sa > sb end
    return tostring(a.ko) < tostring(b.ko)
  end)
  return out
end

function DB.GetWeaponPoolForSpecV13(specKey)
  local spec = SPECS and SPECS[specKey]
  if not spec then return {} end
  local token = DB.PRIMARY_TOKEN_V13[spec.primary]
  local out = {}
  for _, item in ipairs(WEAPONS or {}) do
    if MS1V13_ContainsToken(item.stat, token) then
      local copy = {}
      for k,v in pairs(item) do copy[k]=v end
      copy.weaponUsabilityRequiresClassFilter = true
      copy.priorityStatus = "PRIMARY_STAT_MATCH__CLASS_WEAPON_PROFICIENCY_CHECK_REQUIRED"
      copy.finalBisVerified = false
      out[#out+1] = copy
    end
  end
  table.sort(out, function(a,b)
    if tostring(a.type) ~= tostring(b.type) then return tostring(a.type) < tostring(b.type) end
    return tostring(a.ko) < tostring(b.ko)
  end)
  return out
end

function DB.GetCandidatePoolForSpecSlotV13(specKey, slot)
  local out = {}
  if DB.TIER_SLOTS_V13[slot] then
    for _, piece in ipairs(DB.GetTierPiecesForSpecV13(specKey)) do
      if piece.slot == slot then out[#out+1] = piece end
    end
    -- 티어 슬롯도 오프피스 후보가 있을 수 있으므로 armor pool을 함께 포함한다.
  end
  if DB.NON_TIER_ARMOR_SLOTS_V13[slot] or DB.TIER_SLOTS_V13[slot] then
    for _, item in ipairs(DB.GetArmorPoolForSpecV13(specKey)) do
      if item.slot == slot then
        local copy = {}
        for k,v in pairs(item) do copy[k]=v end
        copy.priorityStatus = "MPLUS_ARMOR_POOL_VERIFIED__RUNTIME_ITEMLINK_STATS_REQUIRED"
        copy.finalBisVerified = false
        out[#out+1] = copy
      end
    end
  elseif slot == "NECK" or slot == "FINGER" or slot == "BACK" then
    for _, item in ipairs(DB.GetAccessoryPoolForSlotV13(slot)) do
      local copy = {}
      for k,v in pairs(item) do copy[k]=v end
      copy.priorityStatus = "MPLUS_ACCESSORY_POOL_VERIFIED__RUNTIME_ITEMLINK_STATS_REQUIRED"
      copy.finalBisVerified = false
      out[#out+1] = copy
    end
  elseif slot == "TRINKET" then
    out = DB.GetTrinketPoolForSpecV13(specKey)
  elseif slot == "MAIN_HAND" or slot == "OFF_HAND" then
    out = DB.GetWeaponPoolForSpecV13(specKey)
  end
  return out
end

function DB.GetActualStatValueV13(record, statKo)
  if not record then return 0 end
  local stats = record.stats or record.rawStats or {}
  return tonumber(stats[statKo] or stats[string.upper(statKo)] or 0) or 0
end

function DB.GetPrimaryStatValueV13(record, specKey)
  local spec = SPECS and SPECS[specKey]
  if not spec then return 0 end
  local keys = DB.PRIMARY_STAT_KEYS_V13[spec.primary] or {}
  local stats = record.stats or record.rawStats or {}
  local total = 0
  for _, key in ipairs(keys) do total = total + (tonumber(stats[key] or 0) or 0) end
  return total
end

function DB.ScoreRuntimeItemV13(record, specKey, slot, options)
  options = options or {}
  if not record then return 0, { level="NO_ITEM" } end
  local spec = SPECS and SPECS[specKey]
  if not spec then return 0, { level="UNKNOWN_SPEC" } end
  local score = 0
  local evidence = { level="RUNTIME_CANDIDATE", notes={} }

  -- 2차 스탯: v1.2 사용자 확정/검증 가중치를 그대로 사용한다.
  for statKo, weight in pairs(spec.secondaryWeights or {}) do
    local value = DB.GetActualStatValueV13(record, statKo)
    if value and value > 0 then
      score = score + value * weight
      evidence.notes[#evidence.notes+1] = statKo .. "=" .. tostring(value) .. "*" .. tostring(weight)
    end
  end

  -- 주스탯/템렙: 2차 스탯만으로 낮은 템렙 고스탯 아이템을 과대평가하지 않도록 보정한다.
  local primary = DB.GetPrimaryStatValueV13(record, specKey)
  if primary > 0 then
    score = score + primary * 120
    evidence.notes[#evidence.notes+1] = "primary=" .. tostring(primary) .. "*120"
  end
  if record.actualItemLevel then
    local ilvlWeight = 35
    if slot == "MAIN_HAND" or slot == "OFF_HAND" then ilvlWeight = 70 end
    if slot == "TRINKET" then ilvlWeight = 45 end
    score = score + record.actualItemLevel * ilvlWeight
    evidence.notes[#evidence.notes+1] = "ilvl=" .. tostring(record.actualItemLevel) .. "*" .. tostring(ilvlWeight)
  end

  -- 티어: 4셋을 유지해야 하므로 티어 후보에 큰 보정. 단 5부위 중 정확한 4부위는 런타임 점수로 고른다.
  local isTier = false
  if record.baseItemId then isTier = DB.IsTierPieceForSpecV13(specKey, record.baseItemId) end
  if record.tierSetPiece or isTier then
    score = score + 7000
    evidence.notes[#evidence.notes+1] = "tierSetPieceBonus=7000"
  end

  -- 신화 트랙: 검증 완료 > 후보 > 미확인 순으로 보정한다.
  if record.mythTrackVerified then
    score = score + 2500
    evidence.level = DB.V13_BIS_VALIDATION_LEVELS.RUNTIME_VERIFIED
    evidence.notes[#evidence.notes+1] = "mythTrackVerified=+2500"
  elseif record.mythTrackCandidate then
    score = score + 1000
    evidence.level = DB.V13_BIS_VALIDATION_LEVELS.RUNTIME_CANDIDATE
    evidence.notes[#evidence.notes+1] = "mythTrackCandidate=+1000"
  else
    evidence.level = DB.V13_BIS_VALIDATION_LEVELS.REVIEW_REQUIRED
    evidence.notes[#evidence.notes+1] = "mythTrackNotVerified"
  end

  -- 장신구 수동 seed 보정. 최종 BiS 확정은 아님.
  if slot == "TRINKET" and record.manualGradeV13 then
    local bonus = DB.TRINKET_GRADE_SCORE_V13[record.manualGradeV13] or 0
    score = score + bonus
    evidence.notes[#evidence.notes+1] = "trinketManualSeed=" .. tostring(record.manualGradeV13) .. "+" .. tostring(bonus)
...
function DB.BuildRuntimeItemRecordV13(itemLink, specKey, sourceType, keyLevel, slot)
  local record = DB.BuildRuntimeItemRecord(itemLink, specKey, sourceType, keyLevel, slot)
  if not record then return nil end
  local isTier, tierPiece = DB.IsTierPieceForSpecV13(specKey, record.baseItemId)
  if isTier then
    record.tierSetPiece = true
    record.tierPiece = tierPiece
  end
  record.v13Score, record.v13Evidence = DB.ScoreRuntimeItemV13(record, specKey, slot)
  return record
end

function DB.BuildStaticSlotPriorityV13(specKey, slot)
  local pool = DB.GetCandidatePoolForSpecSlotV13(specKey, slot)
  local out = {}
  for _, item in ipairs(pool) do
    local copy = {}
    for k,v in pairs(item) do copy[k]=v end
    copy.staticPriorityStatus = DB.V13_BIS_VALIDATION_LEVELS.STATIC_POOL_ONLY
    copy.requiresRuntimeItemLink = true
    copy.mythTrackVerified = false
    copy.bisOptimalVerified = false
    out[#out+1] = copy
  end
  table.sort(out, function(a,b)
    if (a.tierSetPiece and not b.tierSetPiece) then return true end
    if (b.tierSetPiece and not a.tierSetPiece) then return false end
    local ga = DB.TRINKET_GRADE_SCORE_V13[a.manualGradeV13 or "C"] or 0
    local gb = DB.TRINKET_GRADE_SCORE_V13[b.manualGradeV13 or "C"] or 0
    if ga ~= gb then return ga > gb end
    return tostring(a.ko or "") < tostring(b.ko or "")
  end)
  return out
end

function DB.BuildRuntimeSlotPriorityV13(specKey, slot, itemLinks, sourceType, keyLevel)
  local out = {}
  for _, link in ipairs(itemLinks or {}) do
    local record = DB.BuildRuntimeItemRecordV13(link, specKey, sourceType, keyLevel, slot)
    if record then out[#out+1] = record end
  end
  table.sort(out, function(a,b) return (a.v13Score or 0) > (b.v13Score or 0) end)
  return out
end

function DB.GetBestFourTierPiecesV13(specKey, tierItemLinks, sourceType, keyLevel)
  local records = {}
  for _, link in ipairs(tierItemLinks or {}) do
    local rec = DB.BuildRuntimeItemRecordV13(link, specKey, sourceType, keyLevel, "TIER")
    if rec and rec.tierSetPiece then records[#records+1] = rec end
  end
  table.sort(records, function(a,b) return (a.v13Score or 0) > (b.v13Score or 0) end)
  local best = {}
  for i=1, math.min(4, #records) do best[#best+1] = records[i] end
  return best, records
end

function DB.GetSpecItemPrioritySnapshotV13(specKey)
  local snapshot = {
    specKey = specKey,
    spec = SPECS and SPECS[specKey] or nil,
    tierPolicy = "티어 5부위 중 실제 itemLink 점수 상위 4개를 사용한다. 정적 고정 4부위는 사용하지 않는다.",
    slots = {},
    validation = {
      itemIdOnlyMythTrackAllowed = false,
      requiresRuntimeItemLink = true,
      staticFinalBisVerified = false,
    }
  }
  for _, slot in ipairs(DB.SLOT_ORDER_V13) do
    snapshot.slots[slot] = DB.BuildStaticSlotPriorityV13(specKey, slot)
  end
  return snapshot
end

DB.PROMPTS.v13FullAddonBuild = [[
...
DB.PROMPTS.v13ValidationReview = [[
이 DB를 검수하라.
검수 순서:
1) 던전명/아이템명/티어명 한글 표기가 공식 또는 Wowhead KO와 일치하는지 확인한다.
2) 각 전문화 secondaryPriority와 secondaryWeights가 사용자 선택/v1.2 표와 일치하는지 확인한다.
3) 후보 아이템이 해당 갑옷군/주스탯/슬롯에 맞는지 확인한다.
4) 신화 여부를 baseItemId로 판정하는 코드가 있는지 검사하고, 있다면 실패 처리한다.
5) 장신구/무기 finalBisVerified=true가 있으면 실패 처리한다. 특수효과는 별도 검증 필요하다.
6) 실제 WoW 클라이언트에서 GetInventoryItemLink -> BuildRuntimeItemRecordV13 -> ScoreRuntimeItemV13 호출 테스트를 수행한다.
]]

-- v1.3 QA용 간단한 정적 점검 함수. WoW 클라이언트 밖에서도 논리상 확인하기 쉬운 결과를 반환한다.
function DB.RunStaticSelfCheckV13()
  local result = { ok=true, errors={}, warnings={}, specCount=0 }
  for specKey, spec in pairs(SPECS or {}) do
    result.specCount = result.specCount + 1
    if not spec.secondaryWeights then
      result.ok = false
      result.errors[#result.errors+1] = specKey .. ": missing secondaryWeights"
    end
    if spec.bisOptimalVerified == true then
      result.warnings[#result.warnings+1] = specKey .. ": static bisOptimalVerified=true should be reviewed"
    end
  end
  if ITEM_TRACK_POLICY and ITEM_TRACK_POLICY.baseItemIdIsDifficultySpecific ~= false then
    result.ok = false
    result.errors[#result.errors+1] = "ITEM_TRACK_POLICY.baseItemIdIsDifficultySpecific must be false"
  end
  return result
end

-- END v1.3 최종 슬롯/아이템 우선순위 런타임 평가 패치
