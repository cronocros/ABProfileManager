...
try {
    Invoke-PythonStep "Build BIS catalog" "scripts/build_bis_catalog.py" @("--overall-only")
    ...
    Invoke-PythonStep "Validate raid/tier/crafted season preview selectors" "scripts/validate_bis_season_preview_links.py"
    Invoke-PythonStep "Validate BIS tooltip static contract" "scripts/validate_bis_tooltip_contract.py"
