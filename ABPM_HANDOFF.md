...
현재 기준 버전은 `v1.3.10`이며, 핵심 기능 구현과 최신 유지보수 반영, 문서 정리, 배포 준비까지 끝난 상태다.
...
- 한밤(Midnight) 지도 오버레이 개선
  - 규칙 기반 라벨 엔진으로 접두어 / 줄바꿈 / 겹침 완화 / 축소 상태 보정을 한 번에 관리
...
- 설정 세션 요약 정리
  - 스크롤 가능한 요약 박스로 전환
  - 제작자 연락처 `crono1232@gmail.com` 표시
- 설정 패널 안정화
...
- 배포 ZIP: `dist/ABProfileManager-v1.3.10.zip`
- 릴리스 노트: `RELEASE_NOTES_v1.3.10.md`
- 소스 백업 ZIP: `backups/source/ABProfileManager-source-v1.3.10-<timestamp>.zip`
- 변경 이력: `CHANGELOG.md`
