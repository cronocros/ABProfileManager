...
현재 기준 버전은 `v1.0.4`이며, 핵심 기능 구현과 인게임 동작 확인이 끝난 상태다.
...
- 배포 ZIP: `dist/ABProfileManager-v1.0.4.zip`
- 릴리스 노트: `RELEASE_NOTES_v1.0.4.md`
- 소스 백업 ZIP: `backups/source/ABProfileManager-source-v1.0.4-<timestamp>.zip`
- 변경 이력: `CHANGELOG.md`
