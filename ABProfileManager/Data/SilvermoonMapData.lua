...
ns.Data.SilvermoonMapData = {
    ...
    maps = {
        ...
        [2395] = {
            density = "normal",
            points = {
                { key = "caeris_fairdawn", labelKey = "map_label_renown_vendor", x = 43.40, y = 47.40, category = "renown", size = 15, priority = 42, preferBelow = true },
                { key = "collegiate_calamity", labelKey = "map_label_collegiate_calamity", x = 49.00, y = 22.00, category = "delve", size = 15, priority = 18, offsetY = -4 },
                ...
                { key = "the_darkway_eversong", labelKey = "map_label_the_darkway", x = 48.00, y = 15.00, category = "delve", size = 15, priority = 18, offsetY = -4 },
        ...
        [2413] = {
            density = "normal",
            points = {
                { key = "harandar_portal_silvermoon", labelKey = "map_label_portal_silvermoon", x = 53.00, y = 56.00, category = "travel", size = 14, priority = 54, offsetX = -26, offsetY = -10, wordsPerLine = 1, preferBelow = true },
                { key = "harandar_portal_voidstorm", labelKey = "map_label_portal_voidstorm", x = 53.00, y = 56.00, category = "travel", size = 14, priority = 54, offsetX = 26, offsetY = -10, wordsPerLine = 1, preferBelow = true },
                { key = "naynar", labelKey = "map_label_renown_vendor", x = 51.00, y = 50.80, category = "renown", size = 15, priority = 42, offsetY = 16, preferBelow = true },
                { key = "blinding_vale", labelKey = "map_label_blinding_vale", x = 27.43, y = 77.98, category = "dungeon", size = 15, priority = 12, offsetY = -4 },
                { key = "grudge_pit", labelKey = "map_label_grudge_pit", x = 70.00, y = 67.00, category = "delve", size = 15, priority = 18, offsetX = -10, offsetY = 12, preferBelow = true },
        ...
        [2405] = {
            density = "normal",
            points = {
                { key = "voidstorm_portal_combined", labelKey = "map_label_portal_silvermoon_harandar", x = 51.60, y = 68.00, category = "travel", size = 14, priority = 54, offsetY = -10, preferBelow = true, manualWrap = true },
                { key = "anomander", labelKey = "map_label_renown_vendor", x = 53.10, y = 69.10, category = "renown", size = 15, priority = 42, offsetY = 18, preferBelow = true },
                { key = "shadowguard_point", labelKey = "map_label_shadowguard_point", x = 37.00, y = 52.00, category = "delve", size = 15, priority = 18, offsetX = -6, offsetY = -10 },
                ...
                { key = "torments_rise", labelKey = "map_label_torments_rise", x = 61.00, y = 71.00, category = "delve", size = 15, priority = 18, offsetY = -4 },
        ...
        [2437] = {
            density = "normal",
            points = {
                { key = "magovu", labelKey = "map_label_renown_vendor", x = 45.80, y = 65.80, category = "renown", size = 15, priority = 42, preferBelow = true },
