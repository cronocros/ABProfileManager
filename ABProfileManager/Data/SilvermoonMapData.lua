...
local silvermoonPoints = {
    ...
    { key = "profession_hub", labelKey = "map_label_profession_hub", x = 45.64, y = 53.99, category = "profession", size = 20, priority = 52 },
    ...
    maps = {
        ...
        [2437] = {
            ...
            points = {
                ...
                { key = "maisara_caverns", labelKey = "map_label_maisara_caverns", x = 80.60, y = 84.30, category = "dungeon", size = 15, priority = 12, offsetX = 8, offsetY = -4 },
            },
        },
        [1270] = {
            density = "normal",
            points = {
                ...
                { key = "magisters_terrace", labelKey = "map_label_magisters_terrace", x = 58.00, y = 25.00, category = "dungeon", size = 16, priority = 12, offsetX = 6, offsetY = -6 },
                { key = "march_on_queldanas", labelKey = "map_label_march_on_queldanas", x = 52.70, y = 84.90, category = "raid", size = 16, priority = 10, offsetY = -6 },
            },
        },
    },
}
