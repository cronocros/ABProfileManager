...
local silvermoonPoints = {
    ...
    { key = "profession_hub", labelKey = "map_label_profession_hub", x = 45.64, y = 53.99, category = "profession", size = 19, priority = 52, width = 104 },
    ...
    { key = "alchemy_trainer", labelKey = "map_label_alchemy_short", x = 46.98, y = 52.07, category = "profession", size = 14, priority = 82, offsetX = 12, offsetY = -8, noWrap = true },
    { key = "herbalism_trainer", labelKey = "map_label_herbalism_short", x = 48.20, y = 51.52, category = "profession", size = 14, priority = 82, offsetX = 24, offsetY = -14, noWrap = true },
    { key = "mining_trainer", labelKey = "map_label_mining_short", x = 42.68, y = 52.84, category = "profession", size = 14, priority = 82, offsetX = -22, offsetY = -4, noWrap = true },
    { key = "blacksmithing_trainer", labelKey = "map_label_blacksmithing_short", x = 43.74, y = 51.86, category = "profession", size = 14, priority = 82, offsetX = -30, offsetY = -14, noWrap = true },
    { key = "engineering_trainer", labelKey = "map_label_engineering_short", x = 43.61, y = 54.06, category = "profession", size = 14, priority = 82, offsetX = -34, offsetY = 14, noWrap = true },
    { key = "leatherworking_trainer", labelKey = "map_label_leatherworking_short", x = 43.21, y = 55.79, category = "profession", size = 14, priority = 82, offsetX = -34, offsetY = 24, noWrap = true },
    { key = "skinning_trainer", labelKey = "map_label_skinning_short", x = 43.27, y = 55.59, category = "profession", size = 14, priority = 82, offsetX = -34, offsetY = 6, noWrap = true },
    { key = "inscription_trainer", labelKey = "map_label_inscription_short", x = 46.81, y = 51.73, category = "profession", size = 14, priority = 82, offsetX = 10, offsetY = -22, noWrap = true },
    { key = "enchanting_trainer", labelKey = "map_label_enchanting_short", x = 47.91, y = 53.90, category = "profession", size = 14, priority = 82, offsetX = 26, offsetY = 8, noWrap = true },
    { key = "tailoring_trainer", labelKey = "map_label_tailoring_short", x = 48.14, y = 54.08, category = "profession", size = 14, priority = 82, offsetX = 28, offsetY = 18, noWrap = true },
    { key = "jewelcrafting_trainer", labelKey = "map_label_jewelcrafting_short", x = 48.13, y = 55.00, category = "profession", size = 14, priority = 82, offsetX = 28, offsetY = 30, noWrap = true },
