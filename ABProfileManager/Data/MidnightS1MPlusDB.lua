...
DB.SPECS = {
  ...
  DEATHKNIGHT_FROST = { classKo="죽음의 기사", specKo="냉기", role="DPS", armor="PLATE", primary="힘", priority="치명타 및 극대화 > 특화 > 가속 > 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["가속"]=70, ["유연성"]=55 } },
  DEATHKNIGHT_UNHOLY = { classKo="죽음의 기사", specKo="부정", role="DPS", armor="PLATE", primary="힘", priority="치명타 및 극대화 > 특화 > 가속 > 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["가속"]=70, ["유연성"]=55 } },

  DEMONHUNTER_DEVOURER = { classKo="악마사냥꾼", specKo="포식", role="DPS", armor="LEATHER", primary="지능", priority="가속 > 치명타 및 극대화 = 특화 > 유연성", weights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["특화"]=85, ["유연성"]=70 } },
  DEMONHUNTER_HAVOC = { classKo="악마사냥꾼", specKo="파멸", role="DPS", armor="LEATHER", primary="민첩", priority="치명타 및 극대화 > 특화 > 가속 > 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["가속"]=70, ["유연성"]=55 } },
  DEMONHUNTER_VENGEANCE = { classKo="악마사냥꾼", specKo="복수", role="TANK", armor="LEATHER", primary="민첩", priority="가속 > 치명타 및 극대화 > 유연성 > 특화", weights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["유연성"]=70, ["특화"]=55 } },

  DRUID_BALANCE = { classKo="드루이드", specKo="조화", role="DPS", armor="LEATHER", primary="지능", priority="특화 > 가속 > 치명타 및 극대화 > 유연성", weights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=70, ["유연성"]=55 } },
  DRUID_FERAL = { classKo="드루이드", specKo="야성", role="DPS", armor="LEATHER", primary="민첩", priority="특화 > 치명타 및 극대화 = 가속 > 유연성", weights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=85, ["유연성"]=70 } },
  DRUID_GUARDIAN = { classKo="드루이드", specKo="수호", role="TANK", armor="LEATHER", primary="민첩", priority="가속 > 유연성 > 특화 = 치명타 및 극대화", weights={ ["가속"]=100, ["유연성"]=85, ["특화"]=70, ["치명타 및 극대화"]=70 }, source="USER_SELECTED" },
  DRUID_RESTO = { classKo="드루이드", specKo="회복", role="HEALER", armor="LEATHER", primary="지능", priority="가속 > 특화 > 유연성 > 치명타 및 극대화", weights={ ["가속"]=100, ["특화"]=85, ["유연성"]=70, ["치명타 및 극대화"]=55 } },

  EVOKER_DEVASTATION = { classKo="기원사", specKo="황폐", role="DPS", armor="MAIL", primary="지능", priority="치명타 및 극대화 > 특화 > 가속 > 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["가속"]=70, ["유연성"]=55 } },
  EVOKER_PRESERVATION = { classKo="기원사", specKo="보존", role="HEALER", armor="MAIL", primary="지능", priority="치명타 및 극대화 > 가속 > 유연성 > 특화", weights={ ["치명타 및 극대화"]=100, ["가속"]=85, ["유연성"]=70, ["특화"]=55 }, source="USER_SELECTED" },
  EVOKER_AUGMENTATION = { classKo="기원사", specKo="증강", role="DPS", armor="MAIL", primary="지능", priority="특화 > 치명타 및 극대화 > 가속 > 유연성", weights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=70, ["유연성"]=55 } },

  HUNTER_BEASTMASTERY = { classKo="사냥꾼", specKo="야수", role="DPS", armor="MAIL", primary="민첩", priority="치명타 및 극대화 = 특화 > 가속 > 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=100, ["가속"]=85, ["유연성"]=70 }, note="자료 간 충돌이 있어 재검토 권장" },
  HUNTER_MARKSMANSHIP = { classKo="사냥꾼", specKo="사격", role="DPS", armor="MAIL", primary="민첩", priority="치명타 및 극대화 > 특화 > 유연성 > 가속", weights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["유연성"]=70, ["가속"]=55 } },
  HUNTER_SURVIVAL = { classKo="사냥꾼", specKo="생존", role="DPS", armor="MAIL", primary="민첩", priority="특화 > 치명타 및 극대화 > 가속 > 유연성", weights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=70, ["유연성"]=55 } },

  MAGE_ARCANE = { classKo="마법사", specKo="비전", role="DPS", armor="CLOTH", primary="지능", priority="가속 > 치명타 및 극대화 = 특화 = 유연성", weights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["특화"]=85, ["유연성"]=85 } },
  MAGE_FIRE = { classKo="마법사", specKo="화염", role="DPS", armor="CLOTH", primary="지능", priority="가속 > 특화 > 유연성 > 치명타 및 극대화", weights={ ["가속"]=100, ["특화"]=85, ["유연성"]=70, ["치명타 및 극대화"]=55 } },
  MAGE_FROST = { classKo="마법사", specKo="냉기", role="DPS", armor="CLOTH", primary="지능", priority="특화 > 치명타 및 극대화 > 가속 > 유연성", weights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=70, ["유연성"]=55 } },

  MONK_BREWMASTER = { classKo="수도사", specKo="양조", role="TANK", armor="LEATHER", primary="민첩", priority="치명타 및 극대화 = 유연성 = 특화 > 가속", weights={ ["치명타 및 극대화"]=100, ["유연성"]=100, ["특화"]=100, ["가속"]=85 }, source="USER_SELECTED" },
  MONK_MISTWEAVER = { classKo="수도사", specKo="운무", role="HEALER", armor="LEATHER", primary="지능", priority="가속 > 치명타 및 극대화 > 유연성 >> 특화", weights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["유연성"]=70, ["특화"]=45 }, source="USER_SELECTED" },
  MONK_WINDWALKER = { classKo="수도사", specKo="풍운", role="DPS", armor="LEATHER", primary="민첩", priority="가속 > 치명타 및 극대화 = 특화 > 유연성", weights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["특화"]=85, ["유연성"]=70 } },

  PALADIN_HOLY = { classKo="성기사", specKo="신성", role="HEALER", armor="PLATE", primary="지능", priority="특화 > 치명타 및 극대화 = 가속 > 유연성", weights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=85, ["유연성"]=70 } },
  PALADIN_PROTECTION = { classKo="성기사", specKo="보호", role="TANK", armor="PLATE", primary="힘", priority="가속 > 치명타 및 극대화 = 특화 > 유연성", weights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["특화"]=85, ["유연성"]=70 } },
  PALADIN_RETRIBUTION = { classKo="성기사", specKo="징벌", role="DPS", armor="PLATE", primary="힘", priority="특화 > 가속 > 치명타 및 극대화 > 유연성", weights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=70, ["유연성"]=55 } },

  PRIEST_DISC = { classKo="사제", specKo="수양", role="HEALER", armor="CLOTH", primary="지능", priority="가속 > 특화 > 치명타 및 극대화 > 유연성", weights={ ["가속"]=100, ["특화"]=85, ["치명타 및 극대화"]=70, ["유연성"]=55 } },
  PRIEST_HOLY = { classKo="사제", specKo="신성", role="HEALER", armor="CLOTH", primary="지능", priority="치명타 및 극대화 > 유연성 = 특화 > 가속", weights={ ["치명타 및 극대화"]=100, ["유연성"]=85, ["특화"]=85, ["가속"]=70 }, source="USER_SELECTED" },
  ...
  WARLOCK_DESTRUCTION = { classKo="흑마법사", specKo="파괴", role="DPS", armor="CLOTH", primary="지능", priority="가속 > 특화 > 치명타 및 극대화 > 유연성", weights={ ["가속"]=100, ["특화"]=85, ["치명타 및 극대화"]=70, ["유연성"]=55 } },

  WARRIOR_ARMS = { classKo="전사", specKo="무기", role="DPS", armor="PLATE", primary="힘", priority="치명타 및 극대화 > 가속 > 특화 > 유연성", weights={ ["치명타 및 극대화"]=100, ["가속"]=85, ["특화"]=70, ["유연성"]=55 } },
  WARRIOR_FURY = { classKo="전사", specKo="분노", role="DPS", armor="PLATE", primary="힘", priority="가속 > 특화 > 치명타 및 극대화 > 유연성", weights={ ["가속"]=100, ["특화"]=85, ["치명타 및 극대화"]=70, ["유연성"]=55 } },
  WARRIOR_PROTECTION = { classKo="전사", specKo="방어", role="TANK", armor="PLATE", primary="힘", priority="가속 > 치명타 및 극대화 > 유연성 > 특화", weights={ ["가속"]=100, ["치명타 및 극대화"]=85, ["유연성"]=70, ["특화"]=55 } },
}
