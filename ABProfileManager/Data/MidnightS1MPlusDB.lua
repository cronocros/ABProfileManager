...
DB.SPECS = {
  ...
  DEATHKNIGHT_FROST = { classKo="죽음의 기사", specKo="냉기", role="DPS", armor="PLATE", primary="힘", priority="치명타 및 극대화 >= 특화 > 가속 > 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=95, ["가속"]=80, ["유연성"]=65 } },
  DEATHKNIGHT_UNHOLY = { classKo="죽음의 기사", specKo="부정", role="DPS", armor="PLATE", primary="힘", priority="치명타 및 극대화 >= 특화 > 가속 > 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=95, ["가속"]=80, ["유연성"]=65 } },

  DEMONHUNTER_DEVOURER = { classKo="악마사냥꾼", specKo="포식", role="DPS", armor="LEATHER", primary="지능", priority="치명타 및 극대화 = 특화 >> 유연성 >> 가속", weights={ ["치명타 및 극대화"]=100, ["특화"]=100, ["유연성"]=75, ["가속"]=50 } },
  DEMONHUNTER_HAVOC = { classKo="악마사냥꾼", specKo="파멸", role="DPS", armor="LEATHER", primary="민첩", priority="치명타 및 극대화 > 특화 > 가속 >> 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["가속"]=70, ["유연성"]=45 } },
  DEMONHUNTER_VENGEANCE = { classKo="악마사냥꾼", specKo="복수", role="TANK", armor="LEATHER", primary="민첩", priority="가속 >= 치명타 및 극대화 = 유연성 = 특화", weights={ ["가속"]=100, ["치명타 및 극대화"]=95, ["유연성"]=95, ["특화"]=95 } },

  DRUID_BALANCE = { classKo="드루이드", specKo="조화", role="DPS", armor="LEATHER", primary="지능", priority="특화 > 치명타 및 극대화 = 가속 > 유연성", weights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=85, ["유연성"]=70 } },
  DRUID_FERAL = { classKo="드루이드", specKo="야성", role="DPS", armor="LEATHER", primary="민첩", priority="특화 > 가속 = 치명타 및 극대화 > 유연성", weights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=85, ["유연성"]=70 } },
  ...
  EVOKER_DEVASTATION = { classKo="기원사", specKo="황폐", role="DPS", armor="MAIL", primary="지능", priority="치명타 및 극대화 > 특화 >= 가속 > 유연성", weights={ ["치명타 및 극대화"]=100, ["특화"]=85, ["가속"]=80, ["유연성"]=65 } },
  ...
  HUNTER_SURVIVAL = { classKo="사냥꾼", specKo="생존", role="DPS", armor="MAIL", primary="민첩", priority="특화 > 치명타 및 극대화 >= 가속 > 유연성", weights={ ["특화"]=100, ["치명타 및 극대화"]=85, ["가속"]=80, ["유연성"]=65 } },

  MAGE_ARCANE = { classKo="마법사", specKo="비전", role="DPS", armor="CLOTH", primary="지능", priority="가속 >>> 유연성 = 치명타 및 극대화 = 특화", weights={ ["가속"]=100, ["유연성"]=65, ["치명타 및 극대화"]=65, ["특화"]=65 } },
  ...
  MAGE_FROST = { classKo="마법사", specKo="냉기", role="DPS", armor="CLOTH", primary="지능", priority="특화 >= 치명타 및 극대화 > 가속 >= 유연성", weights={ ["특화"]=100, ["치명타 및 극대화"]=95, ["가속"]=80, ["유연성"]=75 } },
  ...
  MONK_WINDWALKER = { classKo="수도사", specKo="풍운", role="DPS", armor="LEATHER", primary="민첩", priority="가속 = 치명타 및 극대화 = 특화 >>> 유연성", weights={ ["가속"]=100, ["치명타 및 극대화"]=100, ["특화"]=100, ["유연성"]=65 } },

  PALADIN_HOLY = { classKo="성기사", specKo="신성", role="HEALER", armor="PLATE", primary="지능", priority="특화 > 가속 = 치명타 및 극대화 > 유연성", weights={ ["특화"]=100, ["가속"]=85, ["치명타 및 극대화"]=85, ["유연성"]=70 } },
  PALADIN_PROTECTION = { classKo="성기사", specKo="보호", role="TANK", armor="PLATE", primary="힘", priority="가속 > 특화 > 치명타 및 극대화 = 유연성", weights={ ["가속"]=100, ["특화"]=85, ["치명타 및 극대화"]=70, ["유연성"]=70 } },
  ...
  PRIEST_SHADOW = { classKo="사제", specKo="암흑", role="DPS", armor="CLOTH", primary="지능", priority="가속 > 특화 => 치명타 및 극대화 > 유연성", weights={ ["가속"]=100, ["특화"]=85, ["치명타 및 극대화"]=80, ["유연성"]=65 } },
  ...
  ROGUE_SUBTLETY = { classKo="도적", specKo="잠행", role="DPS", armor="LEATHER", primary="민첩", priority="특화 >= 가속 > 치명타 및 극대화 > 유연성", weights={ ["특화"]=100, ["가속"]=95, ["치명타 및 극대화"]=80, ["유연성"]=65 } },
  ...
  WARLOCK_DEMONOLOGY = { classKo="흑마법사", specKo="악마", role="DPS", armor="CLOTH", primary="지능", priority="가속 = 치명타 및 극대화 > 특화 > 유연성", weights={ ["가속"]=100, ["치명타 및 극대화"]=100, ["특화"]=85, ["유연성"]=70 } },
  WARLOCK_DESTRUCTION = { classKo="흑마법사", specKo="파괴", role="DPS", armor="CLOTH", primary="지능", priority="가속 = 치명타 및 극대화 > 특화 > 유연성", weights={ ["가속"]=100, ["치명타 및 극대화"]=100, ["특화"]=85, ["유연성"]=70 } },
