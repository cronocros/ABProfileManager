...
local LOCALE_STRINGS_RURU = {
  ...
  ["world_event_haranirLegends"] = "Легенды харанир",
  ["world_event_loc_abundance"] = "Ротация по четырём зонам",
  ["world_event_loc_zone_eversong"] = "Леса Вечной Песни",
  ["world_event_loc_zone_zulaman"] = "Зул'Аман",
  ["world_event_loc_zone_harandar"] = "Harandar",
  ["world_event_loc_zone_voidstorm"] = "Voidstorm",
  ["world_event_state_weekly"] = "Еженедельно",
  ["world_event_state_unknown"] = "Не подтверждено",
  ["world_event_timer_hm"] = "%dч %dм",
  ["world_event_timer_ms"] = "%dм %dс",
  ["world_event_timer_s"] = "%dс",
  ...
  ["world_event_loc_haranirLegends"] = "Harandar",
  ["world_event_loc_saltherilsSoiree"] = "Леса Вечной Песни",
  ["world_event_loc_stormarionAssault"] = "Voidstorm",
  ...
  ["world_event_saltherilsSoiree"] = "Званый вечер Сальтерила",
  ["world_event_stormarionAssault"] = "Штурм Стормариона",
  ...
  ["bis_overlay_policy_summary"] = "Характеристики: %s · не финальный BIS",
  ["bis_overlay_policy_summary_empty"] = "Только для справки. Для финального BIS нужен сим.",
  ["bis_row_favorite"] = "Избранное",
  ["bis_row_favorite_hint"] = "Закрепить предмет в разделе «Избранное» для этого персонажа и специализации.",
  ["bis_row_owned"] = "В наличии",
  ["bis_row_owned_hint"] = "Отметить предмет как имеющийся у этого персонажа и специализации.",
  ["bis_slot_chest"] = "Грудь",
  ["bis_slot_cloak"] = "Плащ",
  ["bis_slot_favorites"] = "Избранное",
  ["bis_slot_feet"] = "Ноги",
  ["bis_slot_hands"] = "Кисти рук",
  ["bis_slot_head"] = "Голова",
  ["bis_slot_legs"] = "Штаны",
  ["bis_slot_neck"] = "Шея",
  ["bis_slot_offhand"] = "Левая рука",
  ["bis_slot_ring"] = "Кольцо",
  ["bis_slot_shield"] = "Щит",
  ["bis_slot_shoulders"] = "Плечи",
  ["bis_slot_trinket"] = "Аксессуар",
  ["bis_slot_waist"] = "Пояс",
  ["bis_slot_weapon"] = "Оружие",
  ["bis_slot_wrist"] = "Запястья",
  ["bis_stat_policy_contextual_summary"] = "проверенный приоритет характеристик; рекомендуется сим",
  ["bis_status_crafted_preserved"] = "Ремесло",
  ["bis_status_raid_preserved"] = "Рейд",
  ["bis_status_runtime_link"] = "нужна ссылка из игры",
  ["bis_status_static_unverified"] = "не финальный BIS / нужен сим",
  ["bis_status_tier_candidate"] = "Тир",
  ["bis_tooltip_actual_item_level"] = "Фактический уровень предмета: %s",
  ["bis_tooltip_actual_stats"] = "Фактические характеристики:",
  ["bis_tooltip_base_item_id"] = "Base ItemID: %s",
  ["bis_tooltip_end_reward_not_myth"] = "Награда за +10 в конце подземелья идёт по треку «Герой», а не «Миф».",
  ["bis_tooltip_item_level"] = "Уровень предмета",
  ["bis_tooltip_item_loading"] = "Загрузка данных предмета",
  ["bis_tooltip_myth_baseline"] = "База автоматической оценки",
  ["bis_tooltip_myth_snapshot_unavailable"] = "Предпросмотр «Миф 1/6 · 272» ещё загружается или не прошёл проверку клиента.",
  ["bis_tooltip_myth_track_candidate"] = "Кандидат Большого хранилища, не подтверждён по itemID",
  ["bis_tooltip_myth_track_itemid_only"] = "По одному itemID нельзя подтвердить трек «Герой»/«Миф» или итоговые характеристики.",
  ["bis_tooltip_myth_track_status"] = "Трек «Миф»",
  ["bis_tooltip_myth_track_verified"] = "Подтверждено ссылкой на предмет из игры",
  ["bis_tooltip_mythic0_preview"] = "Предпросмотр предмета из эпохального подземелья",
  ["bis_tooltip_requirement"] = "Требование",
  ["bis_tooltip_reward_context"] = "Условия получения",
  ["bis_tooltip_runtime_link_required"] = "Политика ссылок на предметы",
  ["bis_tooltip_stat_calc_base"] = "Основа: только Base ItemID",
  ["bis_tooltip_stat_calc_base_warning"] = "В статических данных доступен только базовый ItemID.",
  ["bis_tooltip_stat_calc_full"] = "Основа: полная itemLink/itemString + bonusID",
  ["bis_tooltip_stat_calc_full_required"] = "Для фактических характеристик трека нужна полная itemString или itemLink с данными bonusID.",
  ["bis_tooltip_stat_policy"] = "Приоритет характеристик",
  ["bis_tooltip_static_final_bis"] = "Статический финальный BIS",
  ["bis_tooltip_track_grade"] = "Трек",
  ["bis_tooltip_validation"] = "Проверка",
  ["bis_track_mplus_myth_baseline"] = "Миф 1/6 · %d",
  ["bis_track_mplus_runtime"] = "Герой/Миф",
  ["config_overview_caught_errors"] = "> Перехвачено ошибок ABPM: %d",
  ["config_overview_hint_errors"] = "-> /abpm log показывает журнал отладки и перехваченные ошибки ABPM.",
  ["config_saved_map_overlay_font_size"] = "Размер текста оверлея карты: %s.",
  ["debug_disabled"] = "Журнал отладки выключен.",
  ["debug_enabled"] = "Журнал отладки включён для этой сессии.",
  ["debug_status"] = "Журнал отладки: %s.",
  ["debug_status_disabled"] = "выключен",
  ["debug_status_enabled"] = "включён",
  ["deleted_source"] = "Удалено: %s",
  ["error_action_pickup_failed"] = "Не удалось взять действие курсором.",
  ["error_action_place_failed"] = "Не удалось поместить действие в выбранную ячейку.",
  ["error_apply_plan_invalid"] = "План применения некорректен.",
  ["error_bar_range_requires"] = "Для диапазона панелей нужны начальная и конечная панели.",
  ["error_delete_source_first"] = "Выберите шаблон для удаления.",
  ["error_delete_template_not_found"] = "Шаблон «%s» не найден.",
  ["error_duplicate_source_first"] = "Сначала выберите шаблон для копирования.",
  ["error_invalid_bar"] = "Неверный номер панели.",
  ["error_invalid_bar_selection"] = "Введите один или несколько корректных номеров панелей.",
  ["error_invalid_logical_slot"] = "Неверный номер ячейки действия.",
  ["error_invalid_range_mode"] = "Неизвестный диапазон применения.",
  ["error_invalid_slot_range"] = "Диапазон ячеек должен быть в пределах 1..196.",
  ["error_invalid_source_kind"] = "Неподдерживаемый тип шаблона.",
  ["error_item_incomplete"] = "Данные предмета неполные.",
  ["error_macro_ambiguous"] = "Под это имя подходит несколько макросов. Нужно точное однозначное совпадение.",
  ["error_macro_body_mismatch"] = "Макрос с таким именем есть, но его содержимое отличается.",
  ["error_macro_incomplete"] = "Данные макроса неполные.",
  ["error_macro_missing"] = "Не удалось найти макрос у этого персонажа.",
  ["error_select_source_first"] = "Сначала выберите шаблон.",
  ["error_slot_actual_blocked"] = "Эта ячейка вне проверенного диапазона ячеек.",
  ["error_slot_mutation_blocked"] = "Эта ячейка вне проверенного диапазона для записи.",
  ["error_slot_scan_blocked"] = "Эта ячейка вне проверенного диапазона для чтения.",
  ["error_source_name_required"] = "Нужно имя шаблона.",
  ["error_source_unavailable"] = "Данные шаблона недоступны.",
  ["error_spell_missing"] = "Заклинание сейчас недоступно.",
  ["error_template_name_required"] = "Нужно ввести имя шаблона.",
  ["error_template_not_found"] = "Шаблон «%s» не найден.",
  ["error_unsupported_action_type"] = "Неподдерживаемый тип действия",
  ["error_unsupported_apply_mode"] = "Неподдерживаемый режим применения.",
  ["ghost_clear_all_done"] = "[Призраки очищены]\n- Удалено призрачных меток с панелей: %d.",
  ["ghost_clear_all_none"] = "Нет призрачных меток для очистки.",
  ["ghost_controls_hint"] = "Перетащите призрака прочь, чтобы убрать его, или бросьте сюда другое действие, чтобы заменить.",
  ["ghost_fallback_slot"] = "Ячейка %d",
  ["ghost_reason_default"] = "Это действие сейчас недоступно у этого персонажа.",
  ["ghost_removed"] = "[Призрак убран]\n- Ячейка: %s\n- Метка недоступного шаблона удалена из ячейки.",
  ["ghost_replaced"] = "[Призрак заменён]\n- Ячейка: %s\n- Новое действие размещено, призрачная метка удалена.",
  ["ghost_unavailable_action"] = "Недоступное действие",
  ["help_apply_template"] = "/abpm apply template <Имя шаблона> [full|bar <n>|bars <начало> <конец>|slots <начало> <конец>] [clear|noclear]",
  ["help_clear"] = "/abpm clear <начальная ячейка> <конечная ячейка>",
  ["help_debug"] = "/abpm debug [on|off|toggle|status]",
  ["help_delete_template"] = "/abpm delete template <Имя шаблона>",
  ["help_errors"] = "/abpm errors",
  ["help_header"] = "Команды:",
  ["help_help"] = "/abpm help",
  ["help_list"] = "/abpm list",
  ["help_open"] = "/abpm",
  ["help_quote"] = "Используйте кавычки, если имя шаблона совпадает со служебными словами. Пример: /abpm apply template \"Bar Layout\" full",
  ["help_savetemplate"] = "/abpm savetemplate <Имя шаблона>",
  ["help_undo"] = "/abpm undo",
  ["mplus_record_best_time"] = "Лучшее",
  ["operation_queued"] = "[В очереди]\n- Выполнится автоматически после боя.\n- Выбранное изменение панелей поставлено в очередь.",
  ["result_apply"] = "[Применение завершено]\n- Применено ячеек: %d\n- Предварительно очищено: %d\n- Призраки или отсутствующие: %d\n- Не поддерживается: %d\n- Пропущено: %d\n- Выбрано ячеек: %d",
  ["result_clear"] = "[Очистка завершена]\n- Очищено ячеек: %d\n- Пропущено ячеек: %d\n- Выбрано ячеек: %d",
  ["saved_template"] = "Шаблон сохранён: %s",
  ["settings_subpanel_action_bars_summary"] = "Текущий диапазон: %s",
  ["settings_subpanel_map_summary"] = "Оверлей: %s  |  Смещение текста: %d пт",
  ["settings_subpanel_professions_summary"] = "Отслеживаемых профессий: %d  |  Последний скан: %s",
  ["settings_subpanel_quests_summary"] = "Безопасная очистка и отказ от всех заданий доступны на главной вкладке «Задания».",
  ["settings_subpanel_templates_summary"] = "Сохранённых шаблонов: %d",
  ["settings_subpanel_utility_summary"] = "Вкладка утилит: оверлеи, вспомогательные инструменты и управление окнами.",
  ["stat_priority_button_label"] = "Приоритет характеристик",
  ["stat_priority_column_class"] = "Класс",
  ["stat_priority_column_primary"] = "Основная",
  ["stat_priority_column_priority"] = "Приоритет вторичных характеристик",
  ["stat_priority_column_spec"] = "Специализация",
  ["stat_priority_dialog_subtitle"] = "База Wowhead, сезон 2. Ветки геройских талантов и контента показаны как есть. Строка вашей текущей специализации подсвечена.",
  ["stat_priority_dialog_title"] = "Таблица приоритета характеристик (Midnight, сезон 2)",
  ["stat_priority_primary_agility"] = "Ловкость",
  ["stat_priority_primary_intellect"] = "Интеллект",
  ["stat_priority_primary_strength"] = "Сила",
  ["stats_overlay_dr_tier_0"] = "Обычная эффективность",
  ["stats_overlay_tooltip_dr_line"] = "Состояние DR: %s  |  Вклад рейтинга: %s",
  ["status_profession_refresh_failed"] = "При обновлении профессий произошла внутренняя ошибка. Интерфейс сохранён.",
  ["status_quest_refresh_failed"] = "При обновлении заданий произошла внутренняя ошибка. Интерфейс сохранён.",
  ["sync_confirm_available_only"] = "Привести к шаблону «%s» только %d применимых сейчас ячеек?\n\nДиапазон: %s\nПропущено недоступных ячеек шаблона: %d",
  ["sync_confirm_clear_extras"] = "Очистить по шаблону «%s» только %d лишних сейчас ячеек?\n\nДиапазон: %s",
  ["sync_confirm_exact"] = "Привести выбранный диапазон в точное соответствие шаблону «%s»?\n\nДиапазон: %s",
  ["sync_confirm_fill_empty"] = "Заполнить по шаблону «%s» только %d пустых сейчас ячеек?\n\nДиапазон: %s",
  ["sync_confirm_sync_diff"] = "Привести к шаблону «%s» только %d отличающихся сейчас ячеек?\n\nДиапазон: %s",
  ["sync_result_skipped_unavailable"] = "- Пропущено недоступных ячеек шаблона: %d",
}
