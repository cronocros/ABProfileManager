...
function MainWindow:Initialize()
    ...
    profilesTab:SetScript("OnClick", safeHandler("MainWindow:profilesTab", function()
        showTab(frame, "profiles")
        refreshCurrentTab(frame)
    end))
    actionBarsTab:SetScript("OnClick", safeHandler("MainWindow:actionBarsTab", function()
        showTab(frame, "action_bars")
        refreshCurrentTab(frame)
    end))
    professionsTab:SetScript("OnClick", safeHandler("MainWindow:professionsTab", function()
        showTab(frame, "professions")
        refreshCurrentTab(frame)
    end))
    mapTab:SetScript("OnClick", safeHandler("MainWindow:mapTab", function()
        showTab(frame, "map")
        refreshCurrentTab(frame)
    end))
    questsTab:SetScript("OnClick", safeHandler("MainWindow:questsTab", function()
        showTab(frame, "quests")
        refreshCurrentTab(frame)
    end))
    configTab:SetScript("OnClick", safeHandler("MainWindow:configTab", function()
        showTab(frame, "config")
        refreshCurrentTab(frame)
    end))
    utilityTab:SetScript("OnClick", safeHandler("MainWindow:utilityTab", function()
        showTab(frame, "utility")
        refreshCurrentTab(frame)
    end))
    statPriorityButton:SetScript("OnClick", safeHandler("MainWindow:statPriorityButton", function()
